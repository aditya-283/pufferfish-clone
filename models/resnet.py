...
__all__ = ['ResNet', 'resnet18', 'baseline_resnet18', 'lowrank_resnet18_conv1x1', 'lowrank_resnet34_conv1x1', 'resnet34', 'resnet50', 
...
def lowrank_resnet34_conv1x1(rank_factor=4, pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _lowrank_resnet_conv1x1('lowrank_resnet34_conv1x1', rank_factor, LowRankBasicBlockConv1x1, [3, 4, 6, 3], pretrained, progress,
                   **kwargs)
